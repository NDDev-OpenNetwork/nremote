<p align="center">
  <img src="../res/logo-header.svg" alt="NRemote - desktopul tău la distanță"><br>
  ...
  <b>Avem nevoie de ajutorul tău pentru a traduce acest README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">NRemote UI</a> și <a href="https://github.com/rustdesk/doc.rustdesk.com">NRemote Doc</a> în limba ta maternă</b>
</p>
...
NRemote primește contribuții de la oricine. Vezi [CONTRIBUTING.md](../docs/CONTRIBUTING.md) pentru ajutor la început.
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: comunică cu [nremote-server](https://github.com/rustdesk/rustdesk-server), așteaptă conexiune directă remote (TCP hole punching) sau prin relay
