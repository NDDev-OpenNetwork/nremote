<p align="center">
  <img src="../res/logo-header.svg" alt="NRemote - Seu desktop remoto"><br>
  ...
  <b>Precisamos da sua ajuda para traduzir este README, a <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">Interface do NRemote</a> e a <a href="https://github.com/rustdesk/doc.rustdesk.com">Documentação do NRemote</a> para o seu idioma nativo</b>
</p>
...
O NRemote acolhe a contribuição de todos. Veja [CONTRIBUTING.md](docs/CONTRIBUTING.md) para ajuda em como começar.
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: Comunica-se com o [nremote-server](https://github.com/rustdesk/rustdesk-server), aguarda por conexão remota direta (perfuração de túnel TCP / hole punching) ou retransmitida.
