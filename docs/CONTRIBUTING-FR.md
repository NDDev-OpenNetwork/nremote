...
# Contribuer à NRemote

NRemote accueille les contributions de tous. Voici les directives si vous
envisagez de nous aider :

## Contributions

Les contributions à NRemote ou à ses dépendances doivent être soumises sous
...
- Si votre correctif n'est pas examiné ou si vous avez besoin qu'une personne
  ...
  revue par [e-mail](mailto:info@nremote.com).
...
Les contributeurs de NRemote se retrouvent fréquemment sur
