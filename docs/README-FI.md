<p align="center">
  <img src="../res/logo-header.svg" alt="NRemote - Etätyöpöytäsi"><br>
...
Juttele meidän kanssa: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/nremote) | [Reddit](https://www.reddit.com/r/nremote) | [YouTube](https://www.youtube.com/@nremote)

[![NRemote Server Pro](https://img.shields.io/badge/NRemote%20Server%20Pro-Edistyneet%20Ominaisuudet-blue)](https://github.com/NDDev-OpenNetwork/nremotepricing.html)

Vielä yksi etätyöpöytäohjelmisto, ohjelmoitu Rust-kielellä. Toimii suoraan pakkauksesta, ei tarvitse asetusta. Hallitset täysin tietojasi, ei tarvitse murehtia turvallisuutta. Voit käyttää meidän rendezvous/relay-palvelinta, [aseta omasi](https://github.com/NDDev-OpenNetwork/nremoteserver), tai [kirjoittaa oma rendezvous/relay-palvelin](https://github.com/rustdesk/rustdesk-server-demo).

NRemote toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.
