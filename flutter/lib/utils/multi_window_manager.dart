...
class NRemoteMultiWindowManager {
  NRemoteMultiWindowManager._();

  static final instance = NRemoteMultiWindowManager._();
  ...
  /// `nRemoteWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final nRemoteWinManager = NRemoteMultiWindowManager.instance;
