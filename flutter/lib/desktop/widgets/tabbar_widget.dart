...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (nRemoteWinManager.getActiveWindows().contains(kMainWindowId)) {
        await nRemoteWinManager.unregisterActiveWindow(kMainWindowId);
      }
