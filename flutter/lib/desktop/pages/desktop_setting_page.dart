...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About NRemote'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://github.com/NDDev-OpenNetwork/nremote#privacy');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://github.com/NDDev-OpenNetwork/nremote');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  //   "Settings" -> "Apps" -> "NRemote" -> "Permissions" -> "Inhibit Shortcuts".
  // For resetting(clearing) the permission from the portal permission store, you can
  // use (replace <desktop-id> with the NRemote desktop file ID):
  ...
  // On a native install this is typically "nremote.desktop"; on Flatpak it is usually
  // the exported desktop ID derived from the Flatpak app-id (e.g. "com.nremote.NRemote.desktop").
  //
