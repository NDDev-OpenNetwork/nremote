...
//
// `ausearch -x /usr/share/nremote/nremote` will return
// ...
...
// type=SYSCALL msg=audit(1750776043.446:192757): arch=c000003e syscall=59 success=no exit=-2 a0=7fb7dbd22da0 a1=1d65f2c0 a2=7ffc25193360 a3=7ffc25194ec0 items=1 ppid=172208 pid=267565 auid=4294967295 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=(none) ses=4294967295 comm="nremote" exe="/usr/share/nremote/nremote" subj=unconfined key="processos_criados"
// ----
// time->Tue Jun 24 10:40:43 2025
...
pub fn get_display_server() -> String {
    ...
    if let Ok(forced_display) = std::env::var("NREMOTE_FORCED_DISPLAY_SERVER") {
