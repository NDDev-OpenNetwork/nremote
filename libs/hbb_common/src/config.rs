...
pub const LINK_DOCS_HOME: &str = "https://github.com/NDDev-OpenNetwork/nremote";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://github.com/NDDev-OpenNetwork/nremote#x11-required";
