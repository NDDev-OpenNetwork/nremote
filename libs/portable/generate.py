...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("nremote".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../nremote-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\nremote\flutter\build\windows\runner\Debug\ -o . -e ..\nremote\flutter\build\windows\runner\Debug\nremote.exe
