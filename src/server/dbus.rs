...
///
/// Note:
/// On linux, we use dbus to communicate between multiple nremote processes.
...
const DBUS_NAME: &str = "org.nremote.nremote";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "NRemote DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.nremote.nremote /dbus org.nremote.nremote.NewConnection string:'PEER_ID'`
