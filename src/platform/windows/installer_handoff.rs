...
mod tests {
    ...
    fn run_install_bootstrap_for_test(bootstrap: &str) -> std::process::Output {
        ...
        command
            .env("PROGRAMDATA", "nremote_untrusted")
            .env("PUBLIC", "nremote_untrusted")
            .env("NREMOTE_HANDOFF_EXPAND", "expanded");
