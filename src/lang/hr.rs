...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na NRemote mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a NRemote ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate NRemote na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, NRemote-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, NRemote-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti NRemote-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [NRemote Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep NRemote background service", "Zadrži NRemote kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje NRemote aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti NRemoteu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti NRemoteu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog NRemotea."),
        ...
        ("verify_nremote_password_tip", "Provjera lozinke za NRemote"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete NRemote, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Ažurirajte NRemote Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti NRemote da pravilno radi kao upravljana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor NRemotea otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa NRemotea"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Molimo ažurirajte NRemote klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, NRemote provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, NRemote će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, NRemote više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: NRemote poslužitelj OSS ne uključuje ovu značajku."),
