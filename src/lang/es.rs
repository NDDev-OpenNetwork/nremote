...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red NRemote en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que NRemote no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar NRemote a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a NRemote de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a NRemote de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que NRemote use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [NRemote Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep NRemote background service", "Dejar NRemote como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a NRemote permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a NRemote permisos de \"Grabar Audio\"."),
        ...
        ("verify_nremote_password_tip", "Verificar la contraseña de NRemote"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses NRemote e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "¡Por favor, actualiza NRemote Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que NRemote no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de NRemote"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de NRemote de fondo"),
        ...
        ("About NRemote", "Acerca de NRemote"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Por favor, actualiza el cliente NRemote a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, NRemote verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, NRemote volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, NRemote no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor NRemote OSS no incluye esta característica."),
