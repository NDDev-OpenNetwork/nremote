...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "زبان"),
        ("Keep NRemote background service", "NRemote پس منظر کی خدمت کو برقرار رکھیں"),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", ""),
        ...
        ("About NRemote", "رستڈیسک کے بارے میں"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
