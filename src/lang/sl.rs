...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem NRemote..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, NRemote v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate NRemoteu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate NRemoteu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno NRemoteu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »NRemote Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep NRemote background service", "Ohrani NRemoteovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije NRemote, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "NRemote potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "NRemote potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_nremote_password_tip", "Preveri geslo za NRemote"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite NRemote, prekinite klic in program zaprite."),
        ("scam_text2", "NRemote omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Prosimo, nadgradite NRemote Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo NRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno NRemotea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri NRemote storitvi v ozadju"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Prosimo, nadgradite NRemote odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto NRemote preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo NRemote ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, NRemote ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik NRemote OSS ne vključuje te funkcije."),
