...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં NRemote શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep NRemote background service", "NRemote બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("View Mode", "વ્યુ મોડ"),
        ("verify_nremote_password_tip", "NRemote પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે NRemote વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "સર્વર પ્રો ને {} માં અપગ્રેડ કરો"),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર NRemote વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે NRemote બતાવો"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "રિમોટ ક્લાયન્ટને {} માં અપગ્રેડ કરો"),
