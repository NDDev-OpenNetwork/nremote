...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem NRemote-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann NRemote in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren NRemote auf dem System."),
        ("Click to upgrade", "Zum Upgraden klicken"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie NRemote Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie NRemote die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie NRemote erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"NRemote Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep NRemote background service", "NRemote im Hintergrund ausführen"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie NRemote die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie NRemote die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von NRemote auf \"Ja\" klicken."),
        ...
        ("verify_nremote_password_tip", "NRemote-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, NRemote zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Bitte aktualisieren Sie NRemote Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass NRemote als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von NRemote"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von NRemote.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von NRemote mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das NRemote-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, NRemote im Hintergrund auszuführen."),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Bitte aktualisieren Sie den NRemote-Client auf der Remote-Seite auf Version {} oder neuer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standardmäßig überprüft NRemote das Serverzertifikat für Protokolle, die TLS verwenden. Wenn diese Option aktiviert ist, überspringt NRemote den Überprüfungsschritt und fährt im Falle eines Überprüfungsfehlers fort."),
        ("Disable UDP", "UDP deaktivieren"),
        ("disable-udp-tip", "Legt fest, ob nur TCP verwendet werden soll. Wenn diese Option aktiviert ist, verwendet NRemote nicht mehr UDP 21116, sondern stattdessen TCP 21116."),
        ("server-oss-not-support-tip", "HINWEIS: NRemote Server OSS enthält diese Funktion nicht."),
