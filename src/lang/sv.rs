...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till NRemote..."),
        ...
        ("install_tip", "På grund av UAC, kan inte NRemote fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera NRemote på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge NRemote \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge NRemote \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [NRemote Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep NRemote background service", "Behåll NRemote i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa NRemote programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge NRemote behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge NRemote behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för NRemote."),
        ...
        ("verify_nremote_password_tip", "Verifiera NRemote-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda NRemote och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Uppgradera NRemote Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra NRemote från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av NRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om NRemote-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla NRemote-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Uppgradera NRemote-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar NRemote serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar NRemote över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder NRemote inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: NRemote server OSS inkluderar inte denna funktion."),
