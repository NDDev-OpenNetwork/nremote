...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Gereed"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het NRemote-netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer NRemote op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u NRemote toestemming geven voor Toegankelijkheid."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u NRemote toestemming geven voor Schermopname."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u NRemote toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [NRemote Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep NRemote background service", "NRemote achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u NRemote toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u NRemote toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende NRemote."),
        ...
        ("verify_nremote_password_tip", "Bevestiging wachtwoord NRemote"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om NRemote te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Upgrade NRemote Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor NRemote mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met NRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het NRemote-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt NRemote op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Upgrade de NRemote client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert NRemote het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat NRemote verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt NRemote niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de NRemote-server."),
