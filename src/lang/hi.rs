...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में NRemote खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep NRemote background service", "NRemote बैकग्राउंड सेवा चालू रखें"),
        ...
        ("View Mode", "व्यू मोड"),
        ("verify_nremote_password_tip", "NRemote पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे NRemote उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "NRemote सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब NRemote विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान NRemote को दिखाएं"),
        ...
        ("About NRemote", "NRemote के बारे में"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "रिमोट NRemote क्लाइंट को संस्करण {} में अपग्रेड करें"),
