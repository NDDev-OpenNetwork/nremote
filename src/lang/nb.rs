...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til NRemote-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan NRemote ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere NRemote på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi NRemote \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi NRemote \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi NRemote mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [NRemote Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for NRemote-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi NRemote tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi NRemote tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende NRemote."),
        ...
        ("verify_nremote_password_tip", "Verifiser NRemote-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke NRemote og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Vennligst oppgrader NRemote Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre NRemote i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av NRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis NRemote-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde NRemote-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Vennligst oppgrader NRemote-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer NRemote serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil NRemote falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil NRemote ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: NRemote server OSS inkluderer ikke denne funksjonen."),
