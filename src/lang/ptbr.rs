...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do NRemote..."),
        ...
        ("install_tip", "Devido ao UAC, o NRemote não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o NRemote no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao NRemote permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao NRemote permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o NRemote use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [NRemote Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep NRemote background service", "Manter o serviço do NRemote executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do NRemote."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do NRemote."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do NRemote."),
        ...
        ("verify_nremote_password_tip", "Verifique a senha do NRemote"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o NRemote e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_nremote_server_pro_to_{}_tip", "Atualize o NRemote Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o NRemote funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por NRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do NRemote estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço NRemote em segundo plano"),
        ...
        ("upgrade_remote_nremote_client_to_{}_tip", "Atualize o cliente NRemote para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o NRemote verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o NRemote ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o NRemote não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor NRemote OSS não inclui este recurso."),
